...
export type WithdrawnGiftsQuery = { __typename?: 'Query', withdrawnGifts: Array<{ __typename?: 'WithdrawnGift', id: string, slug: string, title: string, price: number }> };
...
export type ProfileQuery = { __typename?: 'Query', profile: { __typename?: 'User', id: number, tgId: string, image?: string | null, username: string, lastName: string, firstName: string, tonAddress?: string | null, referralCode: string, referredBy?: string | null, balance: number, displayName: string, winRate?: number | null, wins?: number | null, losses?: number | null, withdrawnGifts: Array<{ __typename?: 'WithdrawnGift', id: string, slug: string, price: number, title: string }> } };
...
export type GetUserQuery = { __typename?: 'Query', user: { __typename?: 'User', id: number, username: string, displayName: string, lastName: string, tonAddress?: string | null, gifts: Array<{ __typename?: 'Gift', id: string, title: string, slug: string, price: number }>, withdrawnGifts: Array<{ __typename?: 'WithdrawnGift', id: string, slug: string, title: string, price: number }> } };
