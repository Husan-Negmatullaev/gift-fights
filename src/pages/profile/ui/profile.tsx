					...
					<div className="scrollbar-hide mt-4">
						<div className="mb-3">
							...
							<div className="grid grid-cols-3 gap-3 justify-center items-center">
								<div className="py-4 rounded-xl bg-dark-blue-50 border border-[#77777778]">
									<p className="text-base text-center text-[#A8A8A8] leading-tight">
										Побед
									</p>
									<p className="text-center text-green text-lg font-bold">
										{profile.wins}
									</p>
								</div>

								<div className="bg-dark-blue-50 py-4 rounded-xl border border-[#77777778]">
									<p className="text-base text-center text-[#A8A8A8] text-wrap leading-tight">
										Проигрышей
									</p>
									<p className="text-center text-red text-lg font-bold">
										{profile.losses}
									</p>
								</div>
