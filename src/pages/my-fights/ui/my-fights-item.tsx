import type { ParticipantWithRelations } from "@/entities/lobby";
	...
	return (
		<div className="bg-[#FFFFFF1A] backdrop-blur-[10px] flex rounded-2xl p-4 flex-col border border-[#FFFFFF1A] relative">
			<div className="flex flex-row justify-between mb-1">
				...
				<div
					className={`${statusConfig.color} text-black px-1 rounded-full text-[10px] font-bold uppercase items-center justify-center flex text-center max-h-6`}
				>
					{statusConfig.text}
				</div>
			</div>
